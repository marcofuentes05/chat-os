...
#ifndef GOOGLE_PROTOBUF_INCLUDED_new_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_new_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_new_2eproto
...
struct TableStruct_new_2eproto {
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_new_2eproto;
namespace chat {
class ChangeStatus;
...
class UserRegistration final :
 ...
 private:
  ...
  friend struct ::TableStruct_new_2eproto;
};
// -------------------------------------------------------------------
...
class MessageCommunication final :
 ...
 public:
  ...
  inline MessageCommunication* New() const final {
    return new MessageCommunication();
  }
  ...
  PROTOBUF_FUTURE_MUST_USE_RESULT std::string* release_recipient();
...
class ClientPetition final :
 ...
 public:
  ...
  PROTOBUF_FUTURE_MUST_USE_RESULT ::chat::UserRegistration* release_registration();
  ...
  PROTOBUF_FUTURE_MUST_USE_RESULT ::chat::UserRequest* release_users();
  ...
  PROTOBUF_FUTURE_MUST_USE_RESULT ::chat::ChangeStatus* release_change();
  ...
  PROTOBUF_FUTURE_MUST_USE_RESULT ::chat::MessageCommunication* release_messagecommunication();
...
class ServerResponse final :
 ...
 public:
  ...
  PROTOBUF_FUTURE_MUST_USE_RESULT std::string* release_servermessage();
  ...
  PROTOBUF_FUTURE_MUST_USE_RESULT ::chat::ConnectedUsersResponse* release_connectedusers();
  ...
  PROTOBUF_FUTURE_MUST_USE_RESULT ::chat::UserInfo* release_userinforesponse();
...
inline std::string* MessageCommunication::release_recipient() {
  ...
  _has_bits_[0] &= ~0x00000002u;
  return recipient_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
...
inline void ClientPetition::set_allocated_registration(::chat::UserRegistration* registration) {
  ...
  if (registration) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::chat::UserRegistration>::GetOwningArena(registration);
...
inline void ClientPetition::set_allocated_users(::chat::UserRequest* users) {
  ...
  if (users) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::chat::UserRequest>::GetOwningArena(users);
    if (message_arena != submessage_arena) {
...
inline void ClientPetition::set_allocated_change(::chat::ChangeStatus* change) {
  ...
  if (change) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::chat::ChangeStatus>::GetOwningArena(change);
    if (message_arena != submessage_arena) {
...
inline void ClientPetition::clear_messagecommunication() {
  if (messagecommunication_ != nullptr) messagecommunication_->Clear();
...
inline void ClientPetition::set_allocated_messagecommunication(::chat::MessageCommunication* messagecommunication) {
  ...
  if (messagecommunication) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::chat::MessageCommunication>::GetOwningArena(messagecommunication);
    if (message_arena != submessage_arena) {
...
void ServerResponse::set_servermessage(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000001u;
 servermessage_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void ServerResponse::_internal_set_servermessage(const std::string& value) {
  _has_bits_[0] |= 0x00000001u;
  servermessage_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* ServerResponse::_internal_mutable_servermessage() {
  _has_bits_[0] |= 0x00000001u;
  return servermessage_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* ServerResponse::release_servermessage() {
  ...
  _has_bits_[0] &= ~0x00000001u;
  return servermessage_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
...
inline void ServerResponse::set_allocated_connectedusers(::chat::ConnectedUsersResponse* connectedusers) {
  ...
  if (connectedusers) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::chat::ConnectedUsersResponse>::GetOwningArena(connectedusers);
    if (message_arena != submessage_arena) {
...
inline void ServerResponse::set_allocated_userinforesponse(::chat::UserInfo* userinforesponse) {
  ...
  if (userinforesponse) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::chat::UserInfo>::GetOwningArena(userinforesponse);
    if (message_arena != submessage_arena) {
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_new_2eproto
